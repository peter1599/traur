...
fn hardcoded_signals() -> Vec<SignalDef> {
    ...
    let defs: Vec<(&str, SignalCategory, u32, &str, bool, bool)> = vec![
        ...
        (
            ...
            Metadata,
            25,
            "Popularity is 0 (no recent usage)",
            false,
            false,
        ),
        (
        ...
        (
            ...
            Metadata,
            5,
            "Package is flagged as out of date",
            false,
            false,
        ),
        // name_analysis
        (
            ...
            Behavioral,
            65,
            "Name looks like impersonation of a popular package",
            false,
            false,
        ),
        (
            ...
            Behavioral,
            55,
            "Name is suspiciously similar to a popular package",
            false,
            false,
        ),
        // maintainer_analysis
        (
            ...
            Behavioral,
            30,
            "Maintainer has only 1 package, created recently",
            false,
            false,
        ),
        (
        ...
        (
            ...
            Behavioral,
            45,
            "Maintainer created 3+ packages in the last 48 hours",
            false,
            false,
        ),
        ...
        (
            ...
            Behavioral,
            15,
            "Package maintainer differs from original submitter",
            false,
            false,
        ),
        (
            ...
            Behavioral,
            50,
            "Adopted package with new git author (orphan takeover pattern)",
            false,
            false,
        ),
        // bin_source_verification
        (
            "B-BIN-GITHUB-ORG-MISMATCH",
            Behavioral,
            50,
            "-bin package source downloads from different GitHub org than upstream",
            false,
            false,
        ),
        (
            "B-BIN-DOMAIN-MISMATCH",
            Behavioral,
            50,
            "-bin package source downloads from different domain than upstream",
            false,
            false,
        ),
        (
            "B-BIN-SUBDOMAIN-MISMATCH",
            Behavioral,
            10,
            "-bin package source downloads from CDN subdomain of upstream",
            false,
            false,
        ),
        ...
        (
            ...
            Temporal,
            25,
            "Package is very new (< 7 days old)",
            false,
            false,
        ),
        (
        ...
        (
            ...
            Temporal,
            25,
            "Git history shows multiple different authors",
            false,
            false,
        ),
        ...
        (
            ...
            Metadata,
            40,
            "Recent AUR comments contain security-related warnings",
            true,
            false,
        ),
        // github_stars
        (
            ...
            Metadata,
            20,
            "Upstream GitHub repo has 0 stars",
            false,
            false,
        ),
        (
            ...
            Metadata,
            10,
            "Upstream GitHub repo has very few stars (<10)",
            false,
            false,
        ),
        (
            ...
            Metadata,
            25,
            "Upstream URL points to GitHub but repo does not exist",
            false,
            false,
        ),
        // pkgbuild_diff_analysis
        (
            "T-DIFF-NEW-SUSPICIOUS",
            Temporal,
            40,
            "Newly introduced suspicious pattern not in prior version",
            false,
            false,
        ),
        (
            "T-DIFF-CHECKSUM-REMOVED",
            Temporal,
            35,
            "Checksum array removed or all entries changed to SKIP",
            false,
            false,
        ),
        (
            "T-DIFF-SOURCE-DOMAIN-CHANGED",
            Temporal,
            30,
            "Source URLs changed to a different domain",
            false,
            false,
        ),
        (
            "T-DIFF-MAJOR-REWRITE",
            Temporal,
            15,
            ">50% of PKGBUILD lines changed (unusual for version bump)",
            false,
            false,
        ),
        // checksum_analysis
        (
            ...
            Pkgbuild,
            30,
            "No checksum array found in PKGBUILD",
            false,
            false,
        ),
        (
            ...
            Pkgbuild,
            25,
            "All checksums are SKIP (no integrity verification)",
            false,
            false,
        ),
        (
            ...
            Pkgbuild,
            10,
            "Using weak checksums (md5/sha1) without stronger alternative",
            false,
            false,
        ),
        (
            ...
            Pkgbuild,
            25,
            "Checksum coverage needs review: source and checksum arrays differ in length",
            false,
            false,
        ),
        // shell_analysis
        (
            ...
            Pkgbuild,
            85,
            "Variable concatenation resolves to download-and-execute",
            true,
            false,
        ),
        (
            ...
            Pkgbuild,
            55,
            "Variable concatenation resolves to dangerous command",
            false,
            false,
        ),
        (
            ...
            Pkgbuild,
            70,
            "Variable with dangerous command in execution position",
            false,
            false,
        ),
        (
            "SA-CHARBYCHAR-CONSTRUCT",
            Pkgbuild,
            75,
            "Printf/echo subshell char-by-char command construction",
            false,
            false,
        ),
        (
            ...
            Pkgbuild,
            50,
            "Embedded long hex string (possible encoded payload)",
            false,
            false,
        ),
        (
            ...
            Pkgbuild,
            50,
            "Embedded long base64 string (possible encoded payload)",
            false,
            false,
        ),
        (
            "SA-HIGH-ENTROPY-HEREDOC",
            Pkgbuild,
            55,
            "Heredoc with high entropy content",
            false,
            false,
        ),
        (
            "SA-BINARY-DOWNLOAD-NOCOMPILE",
            Pkgbuild,
            60,
            "Downloads file and chmod +x with no compilation step",
            false,
            false,
        ),
        ...
        (
            ...
            Pkgbuild,
            55,
            "Setting SUID/SGID bit in install script (privilege escalation)",
            false,
            false,
        ),
        // NPM legitimacy check
        (
            "N-NPM-LEGITIMACY-CHECKED",
            Pkgbuild,
            0,
            "NPM package legitimacy verified by deep analysis",
            false,
            false,
        ),
    ];
